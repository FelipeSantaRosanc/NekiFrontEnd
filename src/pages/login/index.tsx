...
import authService from "../../service/api/request/AuthService";
import { storeLocalData } from "../../service/LocalStorageService";
    ...
    <View style={[styles.container, themeContainerStyle]}>
      ...
      <SafeAreaView>
        <Animatable.View animation="fadeInUp" style={styles.containerImput}>
          ...
          >
            <Text style={[styles.textoLink, themeTextStyle]}>
              Não possuo cadastro
            </Text>
          </TouchableOpacity>
          {/* <CheckBox
        ...
        <View style={styles.containerBotao}>
          ...
          >
            <View style={styles.containerTextoBotao}>
              ...
              <Image
                source={Seta}
                style={[styles.setaBotao, themeContainerStyle]}
              />
            </View>
          </TouchableOpacity>
        </View>
